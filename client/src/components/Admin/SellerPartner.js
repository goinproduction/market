...
export default function SellerPartner() {
    ...
    const { partnerState: { accepted }, getAcceptedSellers, deleteGroBySellerId, deleteSellerById, getAcceptedSellerById } = useContext(PartnerContext)
    useEffect(() => {
        getAcceptedSellers();
    }, [])
    ...
    const handleSearchClick = async (e) => {
        e.preventDefault();
        try {
            const object = await getAcceptedSellerById(partnerId);
    ...
    return (
        <div className="seller-partner">
            <Table striped bordered hover style={{ fontSize: '15px', marginTop: '30px' }}>
                <thead>
                    <tr><th colSpan="11">DANH SÁCH ĐỐI TÁC BÁN HÀNG</th></tr>
                ...
                <Form>
                    <div className="form-update">
                        <div className="form-left">
                            ...
                            <div className="mb-3 disable-input">
                                <label>10. Giấy phép kinh doanh</label>
